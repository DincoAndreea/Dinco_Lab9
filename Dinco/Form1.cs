...
namespace Dinco
{
    public partial class Form1 : Form
    {
        ...
        {
            if(comboBox1.SelectedItem.ToString() == "Piramida")
            {
            ...
            if (comboBox1.SelectedItem.ToString() == "Obiect neregulat 1")
            {
                Console.WriteLine("Obiect neregulat 1");
                obiect1 = true;
                loadObiect1();
                DeseneazaObiect1();
                statusFiles = true;
            ...
            if (comboBox1.SelectedItem.ToString() == "Obiect neregulat 2")
            {
                Console.WriteLine("Obiect neregulat 2");
                obiect2 = true;
                loadObiect2();
                DeseneazaObiect2();
                statusFiles = true;
